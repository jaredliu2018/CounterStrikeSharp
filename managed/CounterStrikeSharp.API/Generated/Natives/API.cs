    ...
    public class NativeAPI
    {
        ...
        public static int PbReadbytes(UserMessage message, string name, IntPtr buffer, int size, int index)
        {
            lock (ScriptContext.GlobalScriptContext.Lock)
            {
                ...
                ScriptContext.GlobalScriptContext.PushPrimitive(index);
                ScriptContext.GlobalScriptContext.SetIdentifier(0x7C714D84);
                ScriptContext.GlobalScriptContext.Invoke();
                ScriptContext.GlobalScriptContext.CheckErrors();
                return ScriptContext.GlobalScriptContext.GetResultPrimitive<int>();
            }
        ...
        public static int PbReadbyteslength(UserMessage message, string name, int index)
        {
            lock (ScriptContext.GlobalScriptContext.Lock)
            {
                ...
                ScriptContext.GlobalScriptContext.PushString(name);
                ScriptContext.GlobalScriptContext.PushPrimitive(index);
                ScriptContext.GlobalScriptContext.SetIdentifier(0xDD0E1F98);
                ScriptContext.GlobalScriptContext.Invoke();
                ScriptContext.GlobalScriptContext.CheckErrors();
                return ScriptContext.GlobalScriptContext.GetResultPrimitive<int>();
            }
        ...
        public static void PbSetbytes(UserMessage message, string name, IntPtr buffer, int size, int index)
        {
            lock (ScriptContext.GlobalScriptContext.Lock)
            {
                ...
                ScriptContext.GlobalScriptContext.PushPrimitive(size);
                ScriptContext.GlobalScriptContext.PushPrimitive(index);
                ScriptContext.GlobalScriptContext.SetIdentifier(0xDDAE234);
                ScriptContext.GlobalScriptContext.Invoke();
                ScriptContext.GlobalScriptContext.CheckErrors();
            }
        }
        ...
        public static void PbAddbytes(UserMessage message, string name, IntPtr buffer, int size)
        {
            lock (ScriptContext.GlobalScriptContext.Lock)
            {
                ...
                ScriptContext.GlobalScriptContext.PushPrimitive(buffer);
                ScriptContext.GlobalScriptContext.PushPrimitive(size);
                ScriptContext.GlobalScriptContext.SetIdentifier(0xF86C0528);
                ScriptContext.GlobalScriptContext.Invoke();
                ScriptContext.GlobalScriptContext.CheckErrors();
            }
        }
        ...
        public static int PbReadbytes(ClientMessage message, string name, IntPtr buffer, int size, int index)
        {
            lock (ScriptContext.GlobalScriptContext.Lock)
            {
                ScriptContext.GlobalScriptContext.Reset();
        ...
        public static int PbReadbyteslength(ClientMessage message, string name, int index)
        {
            lock (ScriptContext.GlobalScriptContext.Lock)
            {
                ScriptContext.GlobalScriptContext.Reset();
                ...
                ScriptContext.GlobalScriptContext.PushString(name);
                ScriptContext.GlobalScriptContext.PushPrimitive(index);
                ScriptContext.GlobalScriptContext.SetIdentifier(0xC017D58E);
                ScriptContext.GlobalScriptContext.Invoke();
                ScriptContext.GlobalScriptContext.CheckErrors();
                return ScriptContext.GlobalScriptContext.GetResultPrimitive<int>();
            }
        ...
        public static void PbSetbytes(ClientMessage message, string name, IntPtr buffer, int size, int index)
        {
            lock (ScriptContext.GlobalScriptContext.Lock)
            {
                ScriptContext.GlobalScriptContext.Reset();
        ...
        public static void PbAddint64(ClientMessage message, string name, long value)
        {
            lock (ScriptContext.GlobalScriptContext.Lock)
            {
                ScriptContext.GlobalScriptContext.Reset();
